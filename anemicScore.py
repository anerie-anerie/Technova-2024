...
#DOUBLE CHECK IMAGE FORMAT (PNG)
nailPath = 'InputImg/nail.png'
palmPath = 'InputImg/palm.jpg'
eyePath = 'InputImg/eye.png'

def aScoring(nailPath, palmPath, eyePath):
    '''
    - args: (str)
    - returns: (float)
    calculates anemic score with paths from the three images
    '''

    def nailScore(img=nailPath):
